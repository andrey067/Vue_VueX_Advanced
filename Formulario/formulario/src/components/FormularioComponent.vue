    ...
    <div class="container">
        <div class="row">
            <div class="col-6 bg-light">
                ...
                <form>
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            <!-- apos perder o foco do input reflete na model -->
                        ...
                        <div class="col">
                            <div class="form-check form-switch">
                                <!-- <input class="form-check-input" type="checkbox" v-model="form.licenca" true-value="SIM"
                                    false-value="NÂO"> -->
                                <input class="form-check-input" type="checkbox" v-model="form.licenca">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            ...
                            <small class="text-muted">Formato: 00.000.000/0000-0</small>
                        </div>
                    </div>
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        <label class="col-3 col-form-label">Placa Merco Sul:</label>
                        <div class="col">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            <input type="file" class="form-control" multiple @change="selecionarArquivo">
                        </div>
                    </div>
                    <hr>
                    <div class="mb-3 row">
            ...
            <div class="col-6 text-white bg-secondary" :style="'background-color' + form.cor + '!important'">
                ...
                <div class="mb-3 row">
                    <span>CARTAO DEBITO: {{ form.cartaoDebito }}</span>
                </div>
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                    ...
                    <ul>
                        ...
                        <!-- adicionar Dias e removendo datas -->
                        <li>
                            {{ $moment(form.dataHoraLocal).add(10, 'days') }}
                        </li>
                        <li>
                            {{ $moment(form.dataHoraLocal).add(1, 'month') }}
                        </li>
                        <li>
                            {{ $moment(form.dataHoraLocal).add(2, 'years') }}
                        </li>
                        <li>
                            {{ $moment(form.dataHoraLocal).subtract(2, 'years') }}
                        </li>
                    </ul>
                </div>
                <div class="mb-3 row">
...
export default defineComponent({
    ...
    data: () => ({
        form: {
            ...
            cor: '',
            range: '',
            hidden: 'Este input esta escondigo',
            file: Object()
        },
        methods: {
