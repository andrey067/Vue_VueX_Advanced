                    ...
                    <div class="card-body bg-pokebola bg-normal">
                        <div class="pokemon">
                            <transition name="zoom">
                                <img src="../assets/img/001.png" v-if="exibirPokemon">
                            </transition>

                            <div class="evolucoes">
                                <transition name="fade">
                                    <img src="../assets/img/003.png" v-if="exibirPokemon">
                                </transition>
                                <transition name="fade">
                                    <img src="../assets/img/002.png" v-if="exibirPokemon">
                                </transition>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col mb-2 pokedex">
                ...
                <div class="row">
                    <div class="pokedex-catalogo">
                        ...
                        <div class="cartao-pokemon bg-grama" @click="exibirPokemon = !exibirPokemon">
                            <h1>1 Bulbasaur</h1>
                            <span>grama</span>
